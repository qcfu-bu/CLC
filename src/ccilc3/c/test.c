...
{
  CLC_ptr DocText_c24_70072; INSTR_struct(&DocText_c24_70072, 24, 1,
                               _70071);
...
int main()
{
  ...
  INSTR_mov(&_301, tmp_70916); return 0;
}
