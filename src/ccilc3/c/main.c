...
clc_ptr addn_29781(clc_ptr _29767, clc_env env)
{
  ...
  switch(((clc_node)_29767)->tag){
    case 4:
      instr_clo(&clo_29772, &lam_29771, 4, 0, _29767, env[0], env[1]);
      instr_mov(&case_29768, clo_29772);
      break;
    case 5:
      instr_mov(&_29773, ((clc_node)_29767)->data[0]);
      instr_clo(&clo_29780, &lam_29779, 5,
        0, _29767, _29773, env[0], env[1]);
...
clc_ptr subn_29801(clc_ptr _29784, clc_env env)
{
  ...
  switch(((clc_node)_29784)->tag){
    case 4:
      instr_clo(&clo_29790, &lam_29789, 5,
        0, _29784, env[0], env[1], env[2]);
      instr_mov(&case_29785, clo_29790);
      break;
    case 5:
      instr_mov(&_29791, ((clc_node)_29784)->data[0]);
      instr_clo(&clo_29800, &lam_29799, 6,
        0, _29784, _29791, env[0], env[1], env[2]);
...
clc_ptr cat_29819(clc_ptr _29804, clc_env env)
{
  ...
  switch(((clc_node)_29804)->tag){
    case 17:
      instr_clo(&clo_29809, &lam_29808, 6,
        0, _29804, env[0], env[1], env[2], env[3]);
      instr_mov(&case_29805, clo_29809);
      break;
    case 18:
      instr_mov(&_29810, ((clc_node)_29804)->data[0]);
      instr_mov(&_29811, ((clc_node)_29804)->data[1]);
      instr_clo(&clo_29818, &lam_29817, 8,
        0, _29804, _29810, _29811, env[0], env[1], env[2], env[3]);
...
{
  clc_ptr clo_29836;
  instr_clo(&clo_29836, &lam_29835, 8,
    0, _29832, env[0], env[1], env[2], env[3], env[4], env[5]);
  return clo_29836;
}
...
{
  clc_ptr clo_29886;
  instr_clo(&clo_29886, &lam_29885, 17,
    0, _29877, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
...
{
  clc_ptr clo_29907;
  instr_clo(&clo_29907, &lam_29906, 19,
    0, _29898, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16]);
  return clo_29907;
}
    ...
    case 13:
      ...
      switch(((clc_node)x_29931)->tag){
        case 22:
          ...
          break;
        case 23:
          instr_clo(&clo_29948, &lam_29947, 30,
            0, _29929, x_29931, _29932, env[0], env[1], env[2], env[3],
...
clc_ptr lam_29956(clc_ptr _29927, clc_env env)
{
  ...
  instr_clo(&clo_29953, &lam_29952, 26,
    0, _29927, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
...
{
  clc_ptr clo_29957;
  instr_clo(&clo_29957, &lam_29956, 24,
    0, _29925, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
...
{
  clc_ptr clo_29959;
  instr_clo(&clo_29959, &lam_29958, 22,
    0, A_29923, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
...
clc_ptr lam_29974(clc_ptr _29967, clc_env env)
{
  ...
  instr_open(&fork_res_29972, &fork_proc_29973, _29967, 26,
    _29967, env[0], env[1], env[2], env[3], env[4], env[5], env[6], env[7],
...
{
  clc_ptr clo_29975;
  instr_clo(&clo_29975, &lam_29974, 25,
    0, _29965, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16], env[17], env[18], env[19], env[20], env[21], env[22]);
  return clo_29975;
}
...
{
  clc_ptr clo_29977;
  instr_clo(&clo_29977, &lam_29976, 23,
    0, A_29963, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
...
{
  clc_ptr clo_29992;
  instr_clo(&clo_29992, &lam_29991, 26,
    0, _29983, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16], env[17], env[18], env[19], env[20], env[21], env[22],
    env[23]);
  return clo_29992;
...
{
  clc_ptr clo_29994;
  instr_clo(&clo_29994, &lam_29993, 24,
    0, A_29981, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16], env[17], env[18], env[19], env[20], env[21]);
  return clo_29994;
}
...
{
  clc_ptr clo_30006;
  instr_clo(&clo_30006, &lam_30005, 25,
    0, A_29998, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16], env[17], env[18], env[19], env[20], env[21], env[22]);
  return clo_30006;
}
...
{
  clc_ptr clo_30018;
  instr_clo(&clo_30018, &lam_30017, 26,
    0, A_30010, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
    env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
    env[15], env[16], env[17], env[18], env[19], env[20], env[21], env[22],
    env[23]);
  return clo_30018;
...
clc_ptr lam_30077(clc_ptr _30067, clc_env env)
{
  ...
  switch(((clc_node)_30067)->tag){
    case 1:
      instr_clo(&clo_30073, &lam_30072, 49,
        0, _30067, env[0], env[1], env[2], env[3], env[4], env[5], env[6],
        env[7], env[8], env[9], env[10], env[11], env[12], env[13], env[14],
        env[15], env[16], env[17], env[18], env[19], env[20], env[21],
...
clc_ptr lam_30081(clc_ptr _30044, clc_env env)
{
  ...
  switch(((clc_node)_30044)->tag){
    case 13:
      ...
      instr_clo(&clo_30078, &lam_30077, 47,
        0, stdout_30048, _30044, x_30046, _30047, env[0], env[1], env[2],
...
clc_ptr lam_30086(clc_ptr _30037, clc_env env)
{
  ...
  switch(((clc_node)_30037)->tag){
    case 1:
      ...
      instr_clo(&clo_30082, &lam_30081, 42,
        0, ref_30039, _30037, env[0], env[1], env[2], env[3], env[4], env[5],
...
clc_ptr lam_30090(clc_ptr _30032, clc_env env)
{
  ...
  switch(((clc_node)_30032)->tag){
    case 13:
      ...
      instr_clo(&clo_30087, &lam_30086, 39,
        0, _30032, x_30034, _30035, env[0], env[1], env[2], env[3], env[4],
...
clc_ptr lam_30094(clc_ptr _30027, clc_env env)
{
  ...
  switch(((clc_node)_30027)->tag){
    case 13:
      ...
      instr_clo(&clo_30091, &lam_30090, 35,
        0, _30027, x_30029, _30030, env[0], env[1], env[2], env[3], env[4],
        env[5], env[6], env[7], env[8], env[9], env[10], env[11], env[12],
        env[13], env[14], env[15], env[16], env[17], env[18], env[19],
        env[20], env[21], env[22], env[23], env[24], env[25], env[26],
...
clc_ptr lam_30099(clc_ptr _30022, clc_env env)
{
  ...
  switch(((clc_node)_30022)->tag){
    case 14:
      ...
      instr_clo(&clo_30095, &lam_30094, 31,
        0, _30022, _30024, _30025, env[0], env[1], env[2], env[3], env[4],
        env[5], env[6], env[7], env[8], env[9], env[10], env[11], env[12],
        env[13], env[14], env[15], env[16], env[17], env[18], env[19],
        env[20], env[21], env[22], env[23], env[24], env[25], env[26]);
...
int main()
{
  ...
  instr_clo(&addn_29782, &addn_29781, 2, 0, 0);
  instr_mov(&addn_3, addn_29782);
  instr_clo(&subn_29802, &subn_29801, 3, 0, addn_3, 0);
  instr_mov(&subn_9, subn_29802);
  instr_clo(&cat_29820, &cat_29819, 4, 0, subn_9, addn_3, 0);
  instr_mov(&cat_67, cat_29820);
  instr_clo(&strlen_29830, &strlen_29829, 5, 0, cat_67, subn_9, addn_3, 0);
  instr_mov(&strlen_74, strlen_29830);
  instr_clo(&lt_29838, &lt_29837, 6,
    0, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&lt_84, lt_29838);
  instr_clo(&stdin_rec_29843, &stdin_rec_29842, 7,
    0, lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&stdin_rec_94, stdin_rec_29843);
  instr_clo(&stdout_rec_29848, &stdout_rec_29847, 8,
    0, stdin_rec_94, lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&stdout_rec_98, stdout_rec_29848);
  instr_clo(&stderr_rec_29853, &stderr_rec_29852, 9,
  ...
  instr_clo(&readline_29867, &readline_29866, 13,
  ...
  instr_clo(&close_out_29896, &close_out_29895, 16,
  ...
  instr_clo(&printerr_29909, &printerr_29908, 17,
  ...
  instr_clo(&close_err_29917, &close_err_29916, 18,
  ...
  instr_clo(&ref_t_29921, &ref_t_29920, 19,
  ...
  instr_clo(&free_ref_30020, &free_ref_30019, 24,
  ...
  instr_clo(&clo_30100, &lam_30099, 27,
