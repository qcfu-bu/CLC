...
clc_ptr addn_69923(clc_ptr _69909, clc_env env)
{
  ...
  switch(((clc_node)_69909)->tag){
    case 4:
      instr_clo(&clo_69914, &lam_69913, 2, env, 1, _69909);
      instr_mov(&case_69910, clo_69914);
      break;
    case 5:
      instr_mov(&_69915, ((clc_node)_69909)->data[0]);
      instr_clo(&clo_69922, &lam_69921, 2, env, 2, _69909, _69915);
...
clc_ptr subn_69943(clc_ptr _69926, clc_env env)
{
  ...
  switch(((clc_node)_69926)->tag){
    case 4:
      instr_clo(&clo_69932, &lam_69931, 3, env, 1, _69926);
      instr_mov(&case_69927, clo_69932);
      break;
    case 5:
      instr_mov(&_69933, ((clc_node)_69926)->data[0]);
      instr_clo(&clo_69942, &lam_69941, 3, env, 2, _69926, _69933);
...
{
  clc_ptr clo_69978;
  instr_clo(&clo_69978, &lam_69977, 6, env, 1, _69974);
  return clo_69978;
}
...
{
  clc_ptr clo_70028;
  instr_clo(&clo_70028, &lam_70027, 15, env, 1, _70019);
  return clo_70028;
}
...
{
  clc_ptr clo_70049;
  instr_clo(&clo_70049, &lam_70048, 17, env, 1, _70040);
  return clo_70049;
}
...
{
  clc_ptr clo_70066;
  instr_clo(&clo_70066, &lam_70065, 19, env, 1, _70061);
  return clo_70066;
}
...
{
  clc_ptr clo_70081;
  instr_clo(&clo_70081, &lam_70080, 22, env, 1, _70076);
  return clo_70081;
}
...
clc_ptr sdocToString_70156(clc_ptr _70107, clc_env env)
{
  ...
  switch(((clc_node)_70107)->tag){
    ...
    case 30:
      ...
      instr_clo(&loop_70138, &loop_70137, 26, env, 3,
        _70107, _70115, _70116);
...
clc_ptr fits_70230(clc_ptr _70159, clc_env env)
{
  ...
  switch(((clc_node)_70159)->tag){
    case 4:
      instr_clo(&clo_70165, &lam_70164, 27, env, 1, _70159);
      instr_mov(&case_70160, clo_70165);
      break;
    case 5:
      instr_mov(&_70166, ((clc_node)_70159)->data[0]);
      instr_clo(&clo_70229, &lam_70228, 27, env, 2, _70159, _70166);
...
{
  clc_ptr clo_70319;
  instr_clo(&clo_70319, &lam_70318, 30, env, 1, _70235);
  return clo_70319;
}
...
{
  clc_ptr clo_70321;
  instr_clo(&clo_70321, &lam_70320, 28, env, 1, _70233);
  return clo_70321;
}
...
{
  clc_ptr clo_70356;
  instr_clo(&clo_70356, &lam_70355, 29, env, 1, _70325);
  return clo_70356;
}
...
{
  clc_ptr clo_70611;
  instr_clo(&clo_70611, &lam_70610, 33, env, 1, _70593);
  return clo_70611;
}
...
{
  clc_ptr clo_70613;
  instr_clo(&clo_70613, &lam_70612, 31, env, 1, _70591);
  return clo_70613;
}
...
{
  clc_ptr clo_70886;
  instr_clo(&clo_70886, &lam_70885, 37, env, 1, _70747);
  return clo_70886;
}
...
{
  clc_ptr clo_70888;
  instr_clo(&clo_70888, &lam_70887, 35, env, 1, _70745);
  return clo_70888;
}
...
int main()
{
  ...
  clc_env env = 0;
  instr_init();
  instr_clo(&addn_69924, &addn_69923, 0, env, 1, 0);
  instr_mov(&addn_3, addn_69924);
  instr_clo(&subn_69944, &subn_69943, 0, env, 2, addn_3, 0);
  instr_mov(&subn_9, subn_69944);
  instr_clo(&cat_69962, &cat_69961, 0, env, 3, subn_9, addn_3, 0);
  instr_mov(&cat_67, cat_69962);
  instr_clo(&strlen_69972, &strlen_69971, 0, env, 4,
    cat_67, subn_9, addn_3, 0);
  instr_mov(&strlen_74, strlen_69972);
  instr_clo(&lt_69980, &lt_69979, 0, env, 5,
    strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&lt_84, lt_69980);
  instr_clo(&stdin_rec_69985, &stdin_rec_69984, 0, env, 6,
    lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&stdin_rec_94, stdin_rec_69985);
  instr_clo(&stdout_rec_69990, &stdout_rec_69989, 0, env, 7,
    stdin_rec_94, lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&stdout_rec_98, stdout_rec_69990);
  instr_clo(&stderr_rec_69995, &stderr_rec_69994, 0, env, 8,
  ...
  instr_clo(&close_out_70038, &close_out_70037, 0, env, 15,
  ...
  instr_clo(&printerr_70051, &printerr_70050, 0, env, 16,
  ...
  instr_clo(&text_70074, &text_70073, 0, env, 20,
    empty_145, dcons_140, close_err_130, printerr_125, close_out_122,
    printline_117, close_in_114, readline_109, stderr_t_108, stdout_t_107,
    stdin_t_106, stderr_rec_102, stdout_rec_98, stdin_rec_94, lt_84,
    strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&text_146, text_70074);
  instr_clo(&nest_70083, &nest_70082, 0, env, 21,
  ...
  instr_clo(&fits_70231, &fits_70230, 0, env, 26,
  ...
  instr_clo(&format_70323, &format_70322, 0, env, 27,
    fits_175, sdocToString_165, group_158, breakWith_155, break_154,
    nest_149, text_146, empty_145, dcons_140, close_err_130, printerr_125,
    close_out_122, printline_117, close_in_114, readline_109, stderr_t_108,
    stdout_t_107, stdin_t_106, stderr_rec_102, stdout_rec_98, stdin_rec_94,
    lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&format_218, format_70323);
  instr_clo(&pretty_70358, &pretty_70357, 0, env, 28,
  ...
  instr_clo(&join_70589, &join_70588, 0, env, 29,
    pretty_269, format_218, fits_175, sdocToString_165, group_158,
    breakWith_155, break_154, nest_149, text_146, empty_145, dcons_140,
    close_err_130, printerr_125, close_out_122, printline_117, close_in_114,
    readline_109, stderr_t_108, stdout_t_107, stdin_t_106, stderr_rec_102,
    stdout_rec_98, stdin_rec_94, lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  instr_mov(&join_275, join_70589);
  instr_clo(&binop_70615, &binop_70614, 0, env, 30,
    join_275, pretty_269, format_218, fits_175, sdocToString_165, group_158,
    breakWith_155, break_154, nest_149, text_146, empty_145, dcons_140,
    close_err_130, printerr_125, close_out_122, printline_117, close_in_114,
    readline_109, stderr_t_108, stdout_t_107, stdin_t_106, stderr_rec_102,
    stdout_rec_98, stdin_rec_94, lt_84, strlen_74, cat_67, subn_9, addn_3, 0);
  ...
  instr_clo(&ifthen_70890, &ifthen_70889, 0, env, 34,
    expr2_291, expr1_290, cond_289, binop_282, join_275, pretty_269,
    format_218, fits_175, sdocToString_165, group_158, breakWith_155,
    break_154, nest_149, text_146, empty_145, dcons_140, close_err_130,
    printerr_125, close_out_122, printline_117, close_in_114, readline_109,
    stderr_t_108, stdout_t_107, stdin_t_106, stderr_rec_102, stdout_rec_98,
  ...
  instr_free_clo(tmp_70895);
  instr_mov(&stdout_70894, tmp_70909);
  instr_clo(&clo_70914, &lam_70913, 0, env, 38,
    stdout_70894, stdout_300, doc_299, ifthen_292, expr2_291, expr1_290,
