...
\begin{document}
  ...
  \subsection{Syntax}
  The syntax of the core type theory is presented in Figure \ref{syntax}. Our type theory contains two sorts of predicative universes $U$ and $L$, being the types of non-linear types and linear types respectively. An additional impredicative universe $Prop$ is the type of propositions in the style of CC.
  ...
  \begin{figure}[H]
    ...
    \begin{grammar}
      ...
      <$m, n, A, B, C$> ::= $U_i$ | $L_i$ | $Prop$ | $x$  \hspace*{4.3em} expressions
