...
\begin{document}
  ...
  \begin{figure}[H]
    ...
    \begin{mathpar}
      ...
      \inferrule
      { \overline{\Gamma} \vdash (x : A) \lrw{s}{t} B \utype L_k \\ 
        \Gamma, x \stype{s} A \vdash n \stype{t} B }
      { \Gamma \vdash \lambda x . n \ltype (x : A) \lrw{s}{t} B }
      \rname{Lolli-$\lambda$}
      \\

      \inferrule
      { \Gamma_1 \vdash m \utype (x : A) \arw{U}{s} B \\
        \pure{\Gamma_2} \\
      ...
      \inferrule
      { \Gamma_1 \vdash m \utype (x : A) \arw{L}{s} B \\
      ...
      \inferrule
      { \Gamma_1 \vdash m \ltype (x : A) \lrw{U}{s} B \\
        \pure{\Gamma_2} \\
        \Gamma_2 \vdash n \utype A \\
        \mrg{\Gamma_1}{\Gamma_2}{\Gamma} }
      { \Gamma \vdash m\ n \stype{s} B[n/x] }
