...
Scheme pstep_ind2 := Induction for pstep Sort Prop
  with pstep'_ind2 := Induction for pstep' Sort Prop.

Combined Scheme pstep_pstep'_ind from pstep_ind2, pstep'_ind2.
