...
| l_lam Γ n A s B t l :
  [ %Γ |- Prod A B s t :- L @ l -: U ] ->
  [ A +{s} Γ |- n :- B -: t ] ->
  [ Γ |- Lam n :- Prod A B s t -: L ]
...
Lemma u_lam_invX Γ n C srt :
  [ Γ |- Lam n :- C -: srt ] -> 
  forall A B s l, 
    (C <: Prod A B U s /\ [A +u %Γ |- B :- Sort s l -: U]) ->
    [ A +u Γ |- n :- B -: s ].
Proof.
  intros.
...
Lemma l_lam_invX Γ n C srt :
  [ Γ |- Lam n :- C -: srt ] -> 
  forall A B s l, 
    (C <: Prod A B L s /\ [□ re Γ |- B :- Sort s l -: U]) ->
    [ A +l Γ |- n :- B -: s ].
Proof.
  intros.
  dependent induction H; firstorder.
