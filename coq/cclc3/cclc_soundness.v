...
Require Export clc_act clc_uniq cclc_linearity.
...
Proof with eauto.
  ...
  { inv ty.
    ...
    inv hs.
    destruct s1.
    have[wf1 wf2]:=merge_context_ok_inv mrg wf0. inv wf1.
    have wf4:ok (_: [Γ1]).
    constructor. apply: re_ok...
    have//=tyA2:=clc_weakening.weakeningN H5.
    have tyM:_: [Γ1] ⊢ Main : Sort L.
    constructor. constructor. apply: re_pure.
    have[x rd1 rd2]:=church_rosser sb.
    have tyx1:=clc_soundness.subject_reduction wf4 tyA2 rd1.
    have tyx2:=clc_soundness.subject_reduction wf4 tyM rd2.
    have//:=unicity tyx1 tyx2.
    have/h{}h:~_: _: Γ0 |> U.
    { move=>k. inv k. inv H1.
    ...
    asimpl in h.
    have/h{}h: Ch (~~r2) A'.[ren (+2)] :L _: A2 :L Γ1 ⊢ Pair (Var 0) (Var 2) L : B.[ren (+2)].
    ...
    have{}tym:=clc_weakening.weakeningN tym.
    asimpl in tym.
    have tyv1:_: Ch r2 A'.[ren (+1)] :L _: [Γ4] ⊢ Var 1 : Ch r2 A'.[ren (+3)].
  ...
  { inv ty. inv H3. inv H2; inv H4.
    { have[wf1 wf2]:=merge_context_ok_inv H3 wf.
      ...
      have {}wf2:ok (_: _: Γ2).
      repeat constructor; eauto.
      have[G1[G2[B0[mrg[ty h]]]]]:=plug_inv wf2 H2.
      inv mrg. inv H6.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H3 wf.
      ...
      { repeat constructor; eauto.
        ...
        rewrite e2.
        apply: clc_substitution.strengthen; eauto. }
      have{wf1' H2}[G1[G2[B0[mrg1[ty1 h1]]]]]:=plug_inv wf1' H2.
      inv mrg1. inv H5.
      have /h1{}h1:~Ch (~~r2) A.[ren (+1)] :L _: Γ4 |> U.
      { move=>k. inv k. }
      have{wf2' H4}[G3[G4[B1[mrg2[ty2 h2]]]]]:=plug_inv wf2' H4.
      inv mrg2. inv H4.
      ...
      have ty3 : _: Ch r2 A :L Γ6 ⊢ (Recv (Var 0)).[ren (+1)] : B'.[ren (+1)] by asimpl.
      move/clc_substitution.strengthen in ty3.
      have//={ty3}[sB' tyB']:=validity wf6 ty3.
      have[r5[r6[A4[B4[s3[sb2[xor2 tyv1]]]]]]]:=recv_inv ty2; subst.
      ...
      inv mrg.
      { have{tyv0}[A5[t2[hs0 sb3]]]:=var_inv tyv0; subst.
        destruct t2. inv hs0.
        have tyv' : _: Ch r2 A :L Γ6 ⊢ (Var 0).[ren (+1)] : (Ch r (Act r0 A' B s)).[ren (+1)].
        simpl; eauto.
        have{}tyv':=clc_substitution.strengthen tyv'.
        have//=[sC tyC]:=validity wf6 tyv'.
        have{tyC} tyI:=ch_inv tyC.
        have{tyI}[tyA' tyB1]:=act_inv tyI.
        have{tyv1}[A6[t3[hs1 sb4]]]:=var_inv tyv1; subst.
        inv hs0. inv hs1. inv H7.
        asimpl in sb3. asimpl in sb4.
        have{sb3}[e7 sb3]:=ch_inj sb3; subst.
        have{sb4}[e7 sb4]:=ch_inj sb4; subst.
        have[eA0[sb5[e7 e8]]]:=pi_inj sb1; subst.
        ...
        have sb8:Act r4 A3 B3 s1 === Act r0 A'.[ren (+1)] B.[ren (0 .: (+2))] s.
        { apply: conv_trans.
          apply: conv_sym.
          apply: sb3.
          eauto. }
        ...
        pose proof (conv_subst (v .: ids) eB7). asimpl in H2.
        ...
        replace (Ch (~~r) B6.[vy.[ren (+1)].[ren (+1)] .: ren (+2)])
          with (Ch (~~r) B6.[vy/].[ren (+1)].[ren (+1)]) in H7 by autosubst.
        replace (Ch r B7.[vy.[ren (+1)].[ren (+1)] .: ren (+2)])
          with (Ch r B7.[vy/].[ren (+1)].[ren (+1)]) in H2 by autosubst.
        replace (Ch r B.[vy.[ren (+1)].[ren (+1)] .: ren (+1)])
          with (Ch r B.[vy.[ren (+1)]/]).[ren (+1)] in H2 by autosubst.
        pose proof (conv_subst (ren (subn^~ 1)) H2). asimpl in H4.
        ...
        have /h1{}h1: Ch (~~r) B6.[vy/].[ren (+1)] :L _: Γ8 ⊢ Var 0 : B0.
        { apply: clc_conv; simpl. apply: H7.
          econstructor.
          repeat constructor; eauto.
          rewrite e7; eauto. }
        ...
        have /h2{}h2:
          _: Ch r B7.[vy/] :L Γ9 ⊢ Pair vy.[ren (+1)].[ren (+1)]%subst (Var 1) L : B'.[ren (+1)].
        { replace (Pair vy.[ren (+1)].[ren (+1)]%subst (Var 1) L)
          ...
          have tyvA': _: _: Γ9 ⊢ vy.[ren (+1)].[ren (+1)] : Ax.[ren (+1)].[ren (+1)].
          ...
          move/clc_substitution.strengthen in tyvA'.
          replace (Sort s) with (Sort s).[ren (+1)].[ren (+1)] in wtyA' by autosubst.
          move/clc_substitution.strengthen in wtyA'.
          move/clc_substitution.strengthen in wtyA'.
          econstructor; simpl. apply: H8. apply: k.
          ...
          rewrite<-re_invo.
          econstructor; eauto.
          destruct s; repeat constructor; eauto using re_pure.
          simpl in tyB1. rewrite<-re_invo in tyB1; eauto.
          apply: clc_weakening.weakeningN; eauto.
          have tyCh:_: [Γ6] ⊢ Ch r B.[vy.[ren (+1)]/] : Sort L.
          destruct s.
          have mrg:_: [Γ6] ∘ _: Γ9 => _: [Γ6].
          constructor. inv H8. replace Γ9 with [Γ9].
          rewrite e8 e5 e0. rewrite<-e3. apply: merge_re_id.
          by rewrite<-pure_re.
          simpl in tyB1. rewrite<-re_invo in tyB1.
          have //=tysB1:=clc_substitution.substitution tyB1 H8 mrg tyvAx.
          econstructor; eauto.
          constructor. apply: re_pure.
          simpl in tyB1. rewrite<-re_invo in tyB1.
          pose proof (clc_substitution.substitutionN vy.[ren (+1)] tyB1) as tysB1.
          simpl in tysB1.
          econstructor; eauto.
          constructor. apply: re_pure.
          apply: clc_conv; simpl.
        ...
        asimpl in H8. rewrite er in H8.
        have {}er: (+1) >>> subn_rec^~ 1 = id.
        f_ext. move=>[|x]//.
        pose proof (conv_subst (ren (subn^~ 1)) H8).
        asimpl in H10. rewrite er in H10. asimpl in H10.
        have[Az[t[hs sbz]]]:=var_inv tyv'; subst.
        ...
        inv k. inv H14.
        have[tyA6 tyB6]:=act_inv ty6.
        have[tyA7 tyB7]:=act_inv ty7.
        ...
        { apply: clc_conv.
          ...
          eauto.
          rewrite e8 e5 e1; eauto. }
        have tyC6: [Γ] ⊢ B6.[vy/] : Proto.
        { destruct s; simpl in tyB6.
          rewrite<-re_invo in tyB6.
          have mrg:[Γ] ∘ Γ9 => [Γ].
          replace Γ9 with [Γ9].
          rewrite e8 e5 e1. apply: merge_re_id.
          rewrite<-pure_re; eauto.
          have//:=clc_substitution.substitution tyB6 H15 mrg tyv6.
          rewrite<-re_invo in tyB6.
          have//tyB4:=clc_substitution.substitutionN vy tyB6. }
        have tyC7: [Γ] ⊢ B7.[vy/] : Proto.
        { destruct s; simpl in tyB7.
          rewrite<-re_invo in tyB7.
          have mrg:[Γ] ∘ Γ9 => [Γ].
          replace Γ9 with [Γ9].
          rewrite e8 e5 e1. apply: merge_re_id.
          rewrite<-pure_re; eauto.
          have//:=clc_substitution.substitution tyB7 H15 mrg tyv7.
          rewrite<-re_invo in tyB7.
          have//:=clc_substitution.substitutionN vy tyB7. }
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H3 wf.
      ...
      { constructor.
        ...
        constructor; eauto.
        apply: re_pure. }
      have[G1[G2[B0[mrg[ty h]]]]]:=plug_inv wf1 H2.
      inv mrg.
      have os:of_sort (_: Γ0) 0 None by constructor.
      have//=oc:=clc_linearity.narity ty os. }
    { have[wf1 wf2]:=merge_context_ok_inv H3 wf.
  ...
  { inv ty. inv H3. inv H2; inv H4.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H3 wf.
      ...
      { constructor.
        ...
        constructor; eauto.
        apply: re_pure. }
      have{wf1' H4}[G1[G2[B0[mrg1[ty1 h1]]]]]:=plug_inv wf1' H4.
      inv mrg1; inv H5.
      have /h1{}h1:~Ch (~~r2) A.[ren (+1)] :L _:Γ4 |> U.
      { move=> k. inv k. }
      have{wf2' H2}[G3[G4[B1[mrg2[ty2 h2]]]]]:=plug_inv wf2' H2.
      inv mrg2; inv H4.
      have /h2{}h2:~_: Ch r2 A :L Γ6 |> U.
      { move=>k. inv k. inv H0. }
      ...
      { econstructor; simpl.
        ...
        apply: re_pure. }
      have//=[sB0 tyB0]:=validity wf3 ty1.
      have{ty1}[r3[r4[A4[B4[s3[sb2[xor1 ty0]]]]]]]:=recv_inv ty1; subst.
      have wfB6: ok (Ch r2 A :L Γ6).
      { econstructor; eauto.
        rewrite e6 e1.
        constructor; eauto.
        apply: re_pure. }
      have//=[sB1 tyB1]:=validity (n_ok wfB6) ty2.
      ...
      replace (Pi A'.[ren (+1)] B.[up (ren (+1))] s t0)
        with (Pi A' B s t0).[ren (+1)] in tyS by autosubst.
      move/clc_substitution.strengthen in tyS.
      have[r5[r6[A3[B5[t[sb1[xor2 ty1]]]]]]]:=send_inv tyS; subst.
      have[_[_[_ e]]]:=pi_inj sb1; subst.
      have[A2[t0[hs sb3]]]:=var_inv ty1; subst.
      inv hs. asimpl in sb3.
      have{sb3}[e sb3]:=ch_inj sb3; subst.
      pose proof (conv_subst (ren (+1)) sb3). asimpl in H.
      have[C[t1[hs sbC]]]:=var_inv ty0; subst.
      ...
      have{sb1}[cA2[sb6[ex _]]]:=pi_inj sb1; subst.
      ...
      have[sC tyC]:=validity wfB8 ty1.
      have{tyC}tyO:=ch_inv tyC.
      have[tyA3 tyB5]:=act_inv tyO.
      have{}tyvx:_: Γ9 ⊢ vy.[ren (+1)] : A3.
      { apply: clc_conv; simpl.
        apply: (conv_sym cA2).
        eauto.
      ...
      have {}tyB5: _: Γ8 ⊢ B5.[vy.[ren (+1)]/] : Proto.
      { destruct s.
        ...
        inv H2; rewrite<-pure_re; eauto.
        simpl in tyB5. rewrite<-re_invo in tyB5.
        have:=clc_substitution.substitution tyB5 H2 mrg tyvx.
        by asimpl.
        simpl in tyB5. rewrite<-re_invo in tyB5.
        have:=clc_substitution.substitutionN vy.[ren (+1)] tyB5.
        rewrite<-pure_re; eauto. }
      have {}tyB5: _: Γ8 ⊢ Ch r5 B5.[vy.[ren (+1)]/] : Sort L.
      { econstructor; eauto. constructor; eauto. }
      have//=wtyB5:=clc_weakening.weakeningN tyB5.
      pose proof (conv_subst (vy.[ren (+1)] .: ids) sb6).
      pose proof (conv_subst (ren (+1)) H0).
      pose proof (conv_subst (vy.[ren (+2)] .: ids) sb5).
      move/(conv_ch r5) in H8.
      asimpl in sb.
      asimpl in H4.
      asimpl in H8.
      have{H0 H4 H8}sb:=conv_trans _ (conv_trans _ H8 H4) sb.
      ...
      { repeat constructor; eauto. }
      have tyv0: _: Ch r5 B6.[vy/] :L Γ8 ⊢ Var 1 : B1.
      { apply: clc_conv; simpl.
        apply: sb.
        repeat econstructor; eauto.
        rewrite e8; eauto. }
      have tyc:=h2 _ _ _ mrgv0 tyv0.
      have//=[sx tyC]:=validity wf3 ty0.
      have{tyC}tyI:=ch_inv tyC.
      have{tyI}[tyA4 tyB4]:=act_inv tyI.
      ...
      have tyvz: _: _: Γ9 ⊢ vy.[ren (+2)] : A4.
      { apply: clc_conv; simpl.
        apply: cA.
        asimpl. by asimpl in tyv.
        rewrite ey. rewrite<-ex; eauto. }
      have {}tyvB4:_: _: [Γ4] ⊢ B4.[vy.[ren (+2)]/] : Proto.
      { destruct s.
        have mrg:_: _: [Γ4] ∘ _: _: Γ9 => _: _: [Γ4].
        repeat constructor.
        replace Γ9 with [Γ9].
        rewrite ey. rewrite<-ex. apply: merge_re_id.
        rewrite<-pure_re; eauto. inv H2; eauto.
        simpl in tyB4. rewrite<-re_invo in tyB4.
        have//:=clc_substitution.substitution tyB4 (key_n H2) mrg tyvz.
        simpl in tyB4. rewrite<-re_invo in tyB4.
        have//=:=clc_substitution.substitutionN vy.[ren (+2)] tyB4. }
      have tyv1:
        Ch (~~r5) B7.[vy/].[ren (+1)] :L _: G3 ⊢
          Pair vy.[ren (+1)].[ren (+1)] (Var 0) L : B0.
      { apply: clc_conv; simpl.
        apply: sb2.
        econstructor; simpl.
        apply: (key_n H2).
      ...
      { destruct s; inv H2.
        ...
        have//:=clc_substitution.substitution tyB6 H4 mrg tyv6.
        simpl in tyB6. rewrite<-re_invo in tyB6.
        have//:=clc_substitution.substitutionN vy tyB6. }
      have {}tyB7: [Γ] ⊢ B7.[vy/] : Proto.
      { destruct s; inv H2.
        have mrg:[Γ] ∘ Γ9 => [Γ].
        replace Γ9 with [Γ9].
        rewrite e9 e6 e1. apply: merge_re_id.
        ...
        have//:=clc_substitution.substitution tyB7 H4 mrg tyv7.
        simpl in tyB7. rewrite<-re_invo in tyB7.
        have//:=clc_substitution.substitutionN vy tyB7. }
      econstructor.
      apply: (erefl (~~r5)).
  ...
  { inv ty. inv H3.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      have[G1[G2[B0[mrg[ty _]]]]]:=plug_inv (n_ok (n_ok wf2)) H4.
      inv mrg. inv H6.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      ...
      constructor; eauto.
      apply: re_pure.
      have[G1[G2[C1[mrg1[tyC h1]]]]]:=plug_inv wfA H3.
      have[G3[D4[C2[mrg2[tyW h2]]]]]:=plug_inv wfB H4.
      inv mrg1; inv H6.
      inv mrg2; inv H6.
      have /h1{}h1 : ~Ch (~~r2) A.[ren (+1)] :L _: Γ4 |> U.
      { move=>k. inv k. }
      have /h2{}h2: ~_: Ch r2 A :L Γ6 |> U.
      { move=>k. inv k. inv H0. }
      have[r3[r4[sbC[xor1 ty0]]]]:=close_inv tyC; subst.
      have[r5[r6[sbW[xor2 ty1]]]]:=wait_inv tyW; subst.
      have[x[tx[hs _]]]:=var_inv ty0; subst.
      inv hs. inv H10.
      have[y[ty[hs _]]]:=var_inv ty1; subst.
      inv hs. inv H6.
      ...
      { econstructor.
        ...
        constructor; eauto.
        apply: re_pure. }
      have//=[sC1 tyC1]:=validity wfA4 tyC.
      have//=[sC2 tyC2]:=validity wfB6 tyW.
      have mrg1: _: _: Γ4 ∘ _: _: Γ5 => _: _: Γ1 by repeat constructor; eauto.
      have mrg2: _: _: Γ6 ∘ _: _: Γ7 => _: _: Γ2 by repeat constructor; eauto.
      have tyU1: _: _: Γ4 ⊢ It.[ren (+2)] : C1.
      { asimpl.
        apply: clc_conv; simpl.
        apply: sbC.
        repeat constructor; eauto.
        eauto. }
      have tyU2: _: _: Γ6 ⊢ It.[ren (+2)] : C2.
      { asimpl.
        apply: clc_conv; simpl.
        apply: sbW.
        repeat constructor; eauto.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      ...
      constructor; eauto.
      apply: re_pure.
      have[G1[G2[B0[mrg[ty _]]]]]:=plug_inv (n_ok wf3) H3.
      inv mrg.
      have os: of_sort (_: Γ0) 0 None by constructor.
      have//:=clc_linearity.narity ty os. }
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      have[G1[G2[B0[mrg[ty _]]]]]:=plug_inv (n_ok (n_ok wf1)) H3.
      inv mrg.
      have os: of_sort (_: Γ0) 0 None by constructor.
      have//:=clc_linearity.narity ty os. } }
  move=>c c' d d' e1 e2 Γ ty wf.
  { inv ty. inv H3.
    ...
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      ...
      constructor; eauto.
      apply: re_pure.
      have[G1[G2[B0[mrg[ty _]]]]]:=plug_inv (n_ok wf3) H4.
      inv mrg.
      have os: of_sort (_: Γ0) 0 None by constructor.
      have//:=clc_linearity.narity ty os. }
    { have[wf1 wf2]:=merge_context_ok_inv H5 wf.
      ...
      constructor; eauto.
      apply: re_pure.
      have[G1[G2[C1[mrg1[tyW h1]]]]]:=plug_inv wfA H4.
      have[G3[D4[C2[mrg2[tyC h2]]]]]:=plug_inv wfB H3.
      inv mrg1; inv H6.
      inv mrg2; inv H6.
      have /h1{}h1 : ~Ch (~~r2) A.[ren (+1)] :L _: Γ4 |> U.
      { move=>k. inv k. }
      ...
      { econstructor.
        ...
        apply: re_pure.
        rewrite e6 e1; eauto. }
      have//=[sC1 tyC1]:=validity wfA4 tyW.
      have//=[sC2 tyC2]:=validity wfB6 tyC.
