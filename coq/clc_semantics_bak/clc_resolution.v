...
Proof.
  ...
  have[Θ4 fr0]:=ih _ _ H3. exists (m0 :U Θ4). constructor; eauto.
  have[Θ4 fr0]:=ih _ _ H3. exists (m0 :L Θ4). constructor; eauto.
  have[Θ4 fr0]:=ih _ _ H3. exists (m0 :L Θ4). constructor; eauto.
  have[Θ4 fr0]:=ih _ _ H3. exists (_: Θ4). constructor; eauto.
Qed.
