...
Require Import AutosubstSsr ARS 
  clc_context clc_ast clc_confluence clc_typing clc_weakening.
...
Proof with eauto using agree_subst, agree_subst_re, agree_subst_key.
  ...
  move=>Γ A B m s r t k tyP ihP tym ihm Δ σ agr. asimpl.
  { apply: clc_lam... }
...
Lemma context_conv Γ m A B C s t :
  B === A -> 
  [Γ] ⊢ A : Sort s : U -> A :{s} Γ ⊢ m : C : t -> B :{s} Γ ⊢ m : C : t.
Proof with eauto.
  move=>conv tpA tpm.
