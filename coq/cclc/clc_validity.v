...
Proof with eauto using clc_type, re_pure, merge_re_id, key.
  ...
  move=>Γ1 Γ2 Γ m n A B C s t i d mrg tyA _ tyB _ _ _ _ _ wf.
    have[_[e1 e2]]:=merge_re_re mrg.
    exists i.
    econstructor; simpl.
    constructor.
  ...
  move=>Γ A B m s tym ihm o.
    ...
    destruct s; simpl.
    rewrite<-re_invo; constructor...
    rewrite<-re_invo; constructor...
  move=>Γ A B m s tym ihm o.
    have[_/ch_inv[_/out_inv[l[tyA[_ tyB]]]]]:=ihm o.
    exists l.
    apply: clc_pi...
    destruct s; simpl.
    rewrite<-re_invo; constructor...
    rewrite<-re_invo; constructor...
  move=>Γ m tym ihm o. exists 0...
  move=>Γ m tym ihm o. exists 0...
