...
Lemma lookup_length Θ l n Θ' : lookup Θ l n Θ' -> l < length Θ.
Proof.
  elim=>{Θ l n Θ'}.
  move=>Θ m l->//=.
  move=>Θ m l->//=.
...
Lemma lookup_empty Θ Θ' n : ~lookup (_: Θ) (length Θ) n Θ'.
Proof.
  elim: Θ Θ' n=>//=.
...
Lemma lookup_wr_fix Θ Θ' l A m :
  lookup Θ l (Fix A m) Θ' -> wr_heap Θ -> Θ = Θ'.
Proof.
